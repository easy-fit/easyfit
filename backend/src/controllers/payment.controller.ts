...
export class PaymentController {
  static getInternalPayments = catchAsync(
  ...
  static getInternalPaymentById = catchAsync(
    async (req: Request, res: Response) => {
  ...
  static getInternalPaymentByExternalId = catchAsync(
    async (req: Request, res: Response) => {
      const externalId = req.params.externalId;
      const payment = await PaymentService.getInternalPaymentByExternalId(
        externalId,
      );
      if (!payment) {
  ...
  static createInternalPayment = catchAsync(
    async (req: Request, res: Response) => {
  ...
  static updateInternalPayment = catchAsync(
    async (req: Request, res: Response) => {
      const paymentId = req.params.id;
      const paymentData = req.body;
      const updatedPayment = await PaymentService.updateInternalPayment(
        paymentId,
        paymentData,
      );
  ...
  static deleteInternalPayment = catchAsync(
    async (req: Request, res: Response) => {
      const paymentId = req.params.id;
