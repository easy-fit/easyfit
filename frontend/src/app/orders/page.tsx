...
const statusConfig = {
  ...
  returned_ok: {
    ...
    icon: CheckCircle,
    description: 'Productos devueltos en buen estado',
  },
  returned_partial: {
    label: 'Devolución Parcial',
    color: 'bg-blue-100 text-blue-800',
    icon: Package,
    description: 'Algunos productos fueron devueltos',
  },
  returned_damaged: {
    label: 'Devuelto Dañado',
    color: 'bg-red-100 text-red-800',
    icon: XCircle,
    description: 'Productos devueltos con daños',
  },
  stolen: {
    label: 'Robado',
    color: 'bg-red-100 text-red-800',
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              {order.shipping.address.formatted.street} {order.shipping.address.formatted.streetNumber}
                            </p>
