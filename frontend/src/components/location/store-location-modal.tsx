...
export function StoreLocationModal({ isOpen, onClose, onLocationSelect, currentLocation }: StoreLocationModalProps) {
  ...
  const handleFinalConfirmation = () => {
    ...
    // Solo devolver la dirección sin guardar (para store settings)
    onLocationSelect(finalAddress);
    onClose();
    toast.success('Dirección seleccionada. Recuerda hacer clic en "Guardar" para confirmar todos los cambios.');
  };

  const handleDirectAddressSelect = (address: string) => {
  ...
  const isProcessing = isLoadingGeocode;
      ...
      <DialogContent className="sm:max-w-md p-0 gap-0">
        <DialogHeader className="p-6 pb-4">
          <DialogTitle className="text-xl font-bold text-[#20313A] font-helvetica">
            {showAdditionalFields ? 'Completá la dirección de la tienda' : 'Ingresá la dirección de la tienda'}
          </DialogTitle>
        </DialogHeader>
              ...
              <div className="bg-[#DBF7DC]/30 p-4 rounded-lg">
                <div className="flex items-center gap-3">
                  <div className="bg-[#9EE493] p-2 rounded-full">
                    <Building className="h-4 w-4 text-[#20313A]" />
                  </div>
                  <div className="flex-1">
                    <p className="font-medium text-[#20313A]">Dirección de la tienda</p>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="apartment"
                      placeholder="Ej: Local A, Oficina 12"
