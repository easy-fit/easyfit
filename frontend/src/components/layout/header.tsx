      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 relative">
          ...
          <div className="flex items-center gap-2 absolute right-4">
            <Button variant="ghost" size="sm" className="hidden md:flex items-center gap-1 text-sm hover:bg-[#DBF7DC]">
            ...
            {isAuthenticated && user ? (
              ...
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="sm" onClick={() => router.push('/login')} className="hover:bg-[#DBF7DC]">
                  Iniciar Sesión
                </Button>
                <Button
                  size="sm"
